...
const SharedCollectionCard = (props) => {
      ...
      <Grid container >
        {collections.map((collection,i) => 
          <Grid key={`collectioncard#${i}`}  container direction="row" alignItems="center" justifyContent="center" item xs={12} padding={2} style={{ backgroundColor: "#E8ECEE" }} marginBottom={2} borderRadius={2}>
            <Typography component={Link} to={`/sharedCollections/${collection.collectionID}`} variant="h5" fontWeight={600} fontFamily={'Roboto'} state={{isSelf: props.isSelf}} style={{ textDecoration: 'none', color: '#102C45' }}>{collection.collectionName} &#40;{collection.numBooks} books total&#41;</Typography>
...
export default SharedCollectionCard